...
TaDebugAna::TaDebugAna():VaAnalysis()
{
  fDoRoot = false;
}

TaDebugAna::~TaDebugAna(){}
...
TaDebugAna::TaDebugAna (const TaDebugAna& copy) 
{
}


TaDebugAna& TaDebugAna::operator=( const TaDebugAna& assign) 
{ 
  return *this; 
}
...
void
TaDebugAna::InitChanLists ()
{
  // Initialize the lists used by InitTree and AutoPairAna.
  // TaDebugAna's implementation puts channels associated with beam
